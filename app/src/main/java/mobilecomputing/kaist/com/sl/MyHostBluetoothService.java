...
public class MyHostBluetoothService {
    ...
    public MyHostBluetoothService(Context context, Handler handler) {
    ...
    public synchronized void stop() {
        if (connectedThread != null) {
            connectedThread.cancel(); //Closes the socket only
            connectedThread = null;
        }
    ...
    private void connectionLost() {
        ...
        MyHostBluetoothService.this.start();
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (state != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (MyHostBluetoothService.this) {
                        switch (state) {
                            case STATE_LISTEN:
    ...
    private class ReadWriteThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                Log.e("read and write io",e.getMessage());
            }
        }
